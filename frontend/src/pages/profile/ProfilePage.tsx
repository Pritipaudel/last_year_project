...
import { biometricService, BiometricProfile } from "@/services/biometricService";
    ...
    <PageTransition variant="fade" className="flex flex-col min-h-screen pb-20 md:pb-6 relative z-10">
      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="pt-6 border-t font-semibold text-center mt-8">
          <Button 
            variant="ghost" 
            className="text-destructive hover:text-destructive hover:bg-destructive/10 w-full mb-12 sm:w-auto font-black"
            onClick={logout}
          >
